...
import {MappedTransport, MapTripPosition, Transport, TripPosition} from "../models/geo";
...
export default class Dashboard extends Vue {
  ...
  get delays(): DelayNotification[] {
    let delayNotis: DelayNotification =  AppModule.notifications.map(noti => noti.getDelay());
...
function toPosition(delay: DelayNotification): MapTripPosition {
  let tpos:TripPosition = {
    ...
    description: delay.getDelay().getDelta().toString() + " Grund ist: " + delay.getDelay().getDetails(),
