...
// /*
// This is a double of the server.go in traindataproducer.
// It would be prettier to move this here finally, i think.
// That would propably need some adjustments somewhere else, as there are some
// import issues.
// */
