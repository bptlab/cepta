 ...
 */
public class NonLazyKryoProtoSerializer extends Serializer<Message> {

    private final Serializer serializer;

    public NonLazyKryoProtoSerializer() {
        this(new KryoProtoSerializer());
    }

    public NonLazyKryoProtoSerializer(Serializer serializer) {
